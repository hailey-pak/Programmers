        ...
        Arrays.sort(arr, (o1, o2) -> {
            if (o1[0].equalsIgnoreCase(o2[0])) {
                ...
                for (int i = 0; i < o1[1].length(); i++) {
                    if (!Character.isDigit(o1[1].charAt(i)) || i==4) {
                        o1Num = Integer.parseInt(o1[1].substring(0, i));
                        break;
                    }
                }
                for (int i = 0; i < o2[1].length(); i++) {
                    if (!Character.isDigit(o2[1].charAt(i)) || i==4) {
                        o2Num = Integer.parseInt(o2[1].substring(0, i));
                        break;
                    }
                }
                return o1Num - o2Num;
